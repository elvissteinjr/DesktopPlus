...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    {
        if (g_pd3dDevice->CreateVertexShader(g_VS, ARRAYSIZE(g_VS), nullptr, &g_pVertexShader) != S_OK)
            return false;
    ...
    {
        if (g_pd3dDevice->CreatePixelShader(g_PS, ARRAYSIZE(g_PS), nullptr, &g_pPixelShader) != S_OK)
            return false;
    }
