// Desktop+: Modified for OpenVR compatibility and more
...
public:
	...
	Matrix4(const Vector3& forward, const Vector3& left, const Vector3& up); //Construct matrix from Forward, Left and Up vectors, resulting in the following matrix:
                                                                             //Fx Lx Ux  0
                                                                             //Fy Ly Uy  0
                                                                             //Fz Lz Uz  0
                                                                             //0   0  0  1
...
inline Matrix4::Matrix4(const Vector3& left, const Vector3& up, const Vector3& forward)
{
    m[0] = left.x; m[1] = up.x; m[2] = forward.x; m[3] = 0.0f;
    m[4] = left.y; m[5] = up.y; m[6] = forward.y; m[7] = 0.0f;
    m[8] = left.z; m[9] = up.z; m[10]= forward.z; m[11]= 0.0f;
